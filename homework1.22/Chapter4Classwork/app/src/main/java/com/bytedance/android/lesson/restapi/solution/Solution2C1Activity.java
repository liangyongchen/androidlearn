...
public class Solution2C1Activity extends AppCompatActivity {
    ...
    public void requestData(View view) {
        ...
        final Retrofit retrofit = RetrofitManager.get("https://api.thecatapi.com");
        Call<List<Cat>> catlist=retrofit.create(ICatService.class).randomCat();

        catlist.enqueue(new Callback<List<Cat>>() {
            @Override
            ...
            public void onFailure(Call<List<Cat>> call, Throwable t) {
                restoreBtn();
                Toast.makeText(Solution2C1Activity.this, "failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
