...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    public void fetchFeed(View view) {
        ...
        final Retrofit retrofit = RetrofitManager.get("http://10.108.10.39:8080");
        Call<FeedResponse> feedlist=retrofit.create(IMiniDouyinService.class).get_feed();

        feedlist.enqueue(new Callback<FeedResponse>() {
            @Override
            ...
            public void onFailure(Call<FeedResponse> call, Throwable t) {
                resetRefreshBtn();
                Toast.makeText(Solution2C2Activity.this, "failed", Toast.LENGTH_SHORT).show();
            }
        });
