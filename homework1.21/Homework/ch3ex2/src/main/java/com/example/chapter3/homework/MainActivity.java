...
public class MainActivity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator scaleAnim = ObjectAnimator.ofPropertyValuesHolder(target, pvhX, pvhY);
        scaleAnim.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        ...
        ObjectAnimator alphaAnimation = ObjectAnimator.ofFloat(target, "alpha", 1, 0.5f);
        ...
        setAnimation.playTogether(alphaAnimation, scaleAnim);
        setAnimation.start();
