...
Java_com_example_rjx_myapplication_FaceDetectHelper_nativeInit(JNIEnv *env,
                                                                       jobject instance) {
//    Android_JNI_GetEnv();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_rjx_myapplication_FaceDetectHelper_nativeDetectFace(JNIEnv *env,
                                                                             jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_rjx_myapplication_FaceDetectHelper_nativeSetFaceDetectModelPath(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_rjx_myapplication_FaceDetectHelper_nativeSetLicense(JNIEnv *env,
                                                                             jobject instance,
                                                                             jstring license_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_rjx_myapplication_FaceDetectHelper_nativeUnInit(JNIEnv *env,
                                                                         jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_rjx_myapplication_FaceDetectHelper_nativeTestWriteBmp(JNIEnv *env,
                                                                               jobject instance) {
