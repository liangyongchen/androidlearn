...
public class MainActivity extends Activity {
    ...
    public void changeicon(int ret)
    {
        if(ret<=2)
            ic.setImageResource(R.drawable.c2);
        else if(ret<=4)
            ic.setImageResource(R.drawable.c4);
        else if(ret<=8)
            ic.setImageResource(R.drawable.c8);
        else if(ret<=16)
            ic.setImageResource(R.drawable.c10);
        else if(ret<=32)
            ic.setImageResource(R.drawable.c20);
        else
            ic.setImageResource(R.drawable.c40);
    }
