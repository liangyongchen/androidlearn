...
public class CustomCameraActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_zoom).setOnClickListener(v -> {
            ...
            parameters.setZoom(parameters.getZoom()==Ori_zoom?10:Ori_zoom);
    ...
    public Camera getCamera(int position) {
        ...
        Ori_zoom=cam.getParameters().getZoom();
        rotationDegree = getCameraDisplayOrientation(CAMERA_TYPE);
    ...
    private void startPreview(SurfaceHolder holder) throws IOException {
        ...
        Camera.Size optimalPreviewSize = getOptimalPreviewSize(sizes,mSurfaceView.getWidth(),mSurfaceView.getHeight());
        if(optimalPreviewSize != null) {
            Para.setPreviewSize(optimalPreviewSize.width, optimalPreviewSize.height);
        }
        mCamera.setPreviewDisplay(holder);
        mCamera.startPreview();
    }
